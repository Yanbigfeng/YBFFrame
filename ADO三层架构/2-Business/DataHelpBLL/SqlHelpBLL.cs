...
using DataAccess.DataHelpDAL;

namespace Business.DataHelpBLL
{
    class SqlHelpBLL
    {
        #region 1.表的操作
        ...
        public static void sqlUserExp()
        {
            ...
            //事物操作
            SqlHelpBLL.UpdateNo("update BaseTable set name='张三' where name=@name", new SqlParameter("@name", "'小七'"));
            SqlHelpBLL.Save();
            //表的关联操作
            read = SqlHelpBLL.Union();
            //详情打印
            while (read.Read())
